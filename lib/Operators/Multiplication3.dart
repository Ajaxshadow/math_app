...
void main(){
  runApp(MaterialApp(
    home: Multiplication3(),
  ));
}

TextEditingController answerController = new TextEditingController();
class Multiplication3 extends StatefulWidget {
  @override
  _Multiplication3State createState() => _Multiplication3State();
}

class _Multiplication3State extends State<Multiplication3> {
