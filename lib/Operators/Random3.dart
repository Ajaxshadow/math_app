...
class Random3 extends StatefulWidget {
  @override
  _Random3State createState() => _Random3State();
}
...
List expressions(){
  ...
  var element = oper[_random.nextInt(oper.length)];
  int a=random.nextInt(10);
  int b=random.nextInt(10);
  //var expr = x.toString() + element + y.toString();
  print(a);
  print(element);
  print(b);
  var expr = randOperators(element,a,b);
  print(expr);
  String q = ""+a.toString()+""+element+""+b.toString();
  A = [q,expr.toString()];
  return A;
}
